 ...
 * calculate a loan payment. Two constructors are required, one that does not
 * accept parameters, and one that does. Where no parameters are used, the “set”
 * methods must be used to store loan parameters within the resulting object.
 * Where parameters are used, the loan parameters are provided to the object
